...
var API_VERSION = "v1";
var USER_AGENT = `${"@clerk/backend"}@${"1.27.0"}`;
...
var generateSignedInAuthObjectProperties = (claims) => {
...
function signedInAuthObject(authenticateContext, sessionToken, sessionClaims) {
  const { actor, sessionId, sessionStatus, userId, orgId, orgRole, orgSlug, orgPermissions, factorVerificationAge } = generateSignedInAuthObjectProperties(sessionClaims);
...
//# sourceMappingURL=chunk-ITZXWUN4.mjs.map